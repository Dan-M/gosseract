...
# You need library files and headers of tesseract and leptonica.
...
# In case you face TESSDATA_PREFIX error, you might need to set env vars
# to specify the directory where "tessdata" is located.
ENV TESSDATA_PREFIX=/usr/share/tesseract-ocr

# Load languages.
# These {lang}.traineddata would be located under ${TESSDATA_PREFIX}/tessdata.
...
RUN cd ${GOPATH}/src/github.com/Dan-M/gosseract && go test
